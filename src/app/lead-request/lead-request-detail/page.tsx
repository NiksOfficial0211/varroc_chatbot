                    ...
                    <div className="col-lg-12">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4 mb-3">
                          <div className="request_list ">
                            State:
                           <span>{leadDetailsResponse.enq_data[0].state_address ? leadDetailsResponse.enq_data[0].state_address.charAt(0).toUpperCase() + leadDetailsResponse.enq_data[0].state_address.replace("_"," ").slice(1).toLowerCase():"--"}</span>
                          ...
                          <div className="col-lg-12 pt-3 mb-4" style={{ backgroundColor: "#f5fdfb", borderRadius: "10px" }} key={index}>
                            ...
                            <div className="row">
                              <div className="col-lg-4 mb-3">
                                <div className="request_list">
                                  Enquiry ID
                                  <span>{duplicates.dealership.dealership_id}</span>
                                </div>
                              </div>
                              <div className="col-lg-4 mb-3">
                                <div className="request_list">
                                  Request Status:
                                  <span>{duplicates.dealership.request_status}</span>
